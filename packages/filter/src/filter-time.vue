<template>
  <div class="filter-time-container">
    ...
    <div class="time-value" v-if="showValue">
      <div>Min
        <el-input
          ref="minInput"
          :size="size"
  ...
  data() {
    const selectOptions = [
      ...
      // },
      {
        ...
        start: getlastTwoYearsMountsToToday(new Date().getFullYear(), new Date().getMonth() + 1) - 1,
    ...
    popoverShow(val) {
      ...
      setTimeout(() => {
        ...
        sstDatePicker.forEach((item, index) => {
          const shortcut = {
            shortcutsYear_1: new Date(this.pickerOptions2.shortcuts[index].startAndEndTime[0]).getFullYear(),
            shortcutsYear_2: new Date(this.pickerOptions2.shortcuts[index].startAndEndTime[1]).getFullYear(),
            shortcutsMonth_1: new Date(this.pickerOptions2.shortcuts[index].startAndEndTime[0]).getMonth(),
            shortcutsMonth_2: new Date(this.pickerOptions2.shortcuts[index].startAndEndTime[1]).getMonth(),
            shortcutsDate_1: new Date(this.pickerOptions2.shortcuts[index].startAndEndTime[0]).getDate(),
            shortcutsDate_2: new Date(this.pickerOptions2.shortcuts[index].startAndEndTime[1]).getDate()
          }
